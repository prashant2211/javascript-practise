...
/*``````````````````````````````````````````````````````````````````````````````````````````````````````````\\
        ...
        let fruit = 'banana';                //String decleration
        ...
        console.log("Length of morefruits: " + morefruits.length);
        ...
        let fruits = 'banana, apple, oranges, blackberry';
        ...
        // Array......
        //---------------------------
        let moreFruits = ['banana', 'apple', 'oranges', 'pineapples'];
        console.log(moreFruits);            // array decleration

        let sec_moreFruits = new Array('banana', 'apple', 'oranges', 'pineapples');
        ...
        let vegetables = ['asparagus', 'tomato', 'broccol'];  // decleare another array

        let allGroceries = moreFruits.concat(vegetables);   // here we combine two arrays
        ...
        let SomeNumbers = [5, 10, 2, 25, 3, 255, 1, 2, 5, 344, 321];
